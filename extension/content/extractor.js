// EKSTRAKTOR - 1:1 KOPIA z notebooklm-d3-extractor.js (DZIAŁAJĄCY!)
// Przerobione z IIFE na obiekt dla extension
...
const Extractor = {
    extractMindMap() {
        ...
        if (!mainSvg) {
            ...
            return { success: false, error: 'No Mind Map found' };
        }
        ...
        if (!firstNode.__data__) {
            ...
            return { success: false, error: 'Cannot access d3.js data' };
        }
